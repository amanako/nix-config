        ...
        options = {
          label = mkOption {
            ...
            description = ''
              ...
              Defaults to the script label (`user.settings.everyday.wallpaper-managers.awww.script.label`)
          ...
          calendar = mkOption {
            ...
            description = ''
              ...
              When both this option and `user.settings.everyday.wallpaper-managers.awww.service.interval` are set, the timer fires when EITHER condition is met.
