...
# Run `nix run .#write-flake` to revalidate it.
{
  ...
  nixConfig = {
    extra-substituters = ["https://nix-community.cachix.org" "https://fzakaria.cachix.org" "https://vic.cachix.org" "https://attic.xuyh0120.win/lantian" "https://nix-gaming.cachix.org" "https://nyx-cache.chaotic.cx" "https://noctalia.cachix.org" "https://niri.cachix.org" "https://amanako.cachix.org" "https://yazi.cachix.org" "https://helix.cachix.org"];
